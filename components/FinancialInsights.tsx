...
const InsightCard: React.FC<{ title: string; icon: React.ReactElement; children: React.ReactNode; borderColorClass: string; }> = ({ title, icon, children, borderColorClass }) => (
     <div className={`bg-white/60 backdrop-blur-xl p-6 rounded-2xl shadow-lg h-full flex flex-col border border-white/20 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl border-t-4 ${borderColorClass}`}>
    ...
    return (
        <div>
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                 <InsightCard title="Financial Tips" borderColorClass="border-primary" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" /></svg>}>
                ...
                <InsightCard title="Expense Prediction" borderColorClass="border-secondary" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /></svg>}>
                                ...
                                <div className="flex space-x-2">
                                    {[1, 2, 3].map(months => (
                                        <button 
                                            ...
                                            className={`px-3 py-1 rounded-md text-sm font-semibold transition-colors ${predictionMonths === months ? 'bg-secondary text-white' : 'bg-gray-200 text-text-secondary hover:bg-gray-300'}`}
                                        >
             ...
             <div className="grid grid-cols-1 gap-6">
                 <InsightCard title="What-If Scenario Simulator" borderColorClass="border-accent" icon={<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" /></svg>}>
